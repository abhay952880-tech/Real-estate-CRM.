...
// 2. Add Telecaller (Done by Broker)
...
// 3. Client Submission & Smart Matching
app.post('/api/client/submit', async (req, res) => {
    try {
        ...
        // Find matching brokers based on location or budget
...
// ================= FRONTEND UI (LOCK UI & STEP-BY-STEP FLOW) =================
app.get('*', (req, res) => {
    res.send(`
    <!DOCTYPE html>
    <html lang="en">
    <head>
        ...
        <style>
            ...
            header { background: #1e293b; color: white; padding: 15px; text-align: center; font-size: 18px; font-weight: bold; }
            ...
            /* Android Friendly Card Leaderboard */
    ...
    <body>
        ...
        <div id="roleSelectorScreen" class="container">
            <div class="card" style="text-align: center; padding: 30px 15px;">
                ...
                <p style="color: #64748b; margin-bottom: 20px;">Please select your role to proceed:</p>
                <button class="btn" onclick="selectRole('broker')">🏢 Broker Admin Login</button>
                <button class="btn btn-success" style="margin-top: 10px;" onclick="selectRole('telecaller')">📞 Telecaller Portal</button>
                <button class="btn btn-warning" style="margin-top: 10px;" onclick="selectRole('client')">🏠 Client Portal (Find Broker)</button>
            </div>
        </div>

        <!-- 1. BROKER ADMIN DASHBOARD (Full Access, Step-by-Step) -->
        <div id="brokerAdminView" class="container hidden">
            <button class="btn" style="background: #64748b; width: auto; padding: 6px 12px; margin-bottom: 15px;" onclick="goHome()">⬅ Back to Roles</button>
            ...
            <div class="card">
                ...
                <!-- Step 3: Android-Friendly Leaderboard -->
        ...
        <!-- 2. TELECALLER PORTAL (Strict Access: Leads, Leaderboard, Profile) -->
        ...
        <!-- 3. CLIENT PORTAL (Fill details -> Matching Brokers list) -->
        ...
        <script>
            ...
            async function loadCallerData() {
                ...
                // Load Leaderboard for Telecaller
            ...
            async function submitClientLead() {
                ...
                if(result.success) {
                    ...
                    if(result.matchedBrokers.length === 0) {
                        bContainer.innerHTML = '<p style="font-size:13px; color:#64748b;">No specific matching brokers found right now, our team will contact you soon.</p>';
                        return;
                    }
                    let bHtml = '';
