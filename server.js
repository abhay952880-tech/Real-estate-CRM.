...
// ================= FRONTEND UI WITH TOP-RIGHT PROFILE & LOCK MECHANISM =================
app.get('*', (req, res) => {
    res.send(`
    <!DOCTYPE html>
    <html lang="en">
    <head>
        ...
        <style>
            ...
            header { background: #1e293b; color: white; padding: 15px; display: flex; justify-content: space-between; align-items: center; font-size: 16px; font-weight: bold; }
            .profile-badge { background: #334155; padding: 6px 12px; border-radius: 20px; font-size: 13px; display: flex; align-items: center; gap: 8px; border: 1px solid #475569; }
            .profile-badge button { background: #dc2626; color: white; border: none; padding: 3px 8px; border-radius: 4px; font-size: 11px; cursor: pointer; }
    ...
    <body>
        <header>
            ...
            <div id="topRightProfile" class="hidden">
                <span id="profileNameDisplay">Role: None</span>
        ...
        <script>
            ...
            // Check existing lock on page load
